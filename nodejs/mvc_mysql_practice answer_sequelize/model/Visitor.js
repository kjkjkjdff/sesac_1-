...
const Visitor = ( Sequelize, DataTypes)=>{    //visitor라는 함수만든거임 모델의 index.js에서 리콰이어할거임. 여기있는 Sequeliz가 index.js의 49번째줄의 첫번째인자인 시퀄라이즈임. datatype은 49번째줄의 Sequelize인 두번째 인자임.
